...
import com.sami.oninecabsystem.FragmentClasses.MapsPassengerFragment;
...
public class MainPassengerActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(MainPassengerActivity.this);
        ...
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(MainPassengerActivity.this, drawer, toolbar,
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_map:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                        new MapsPassengerFragment()).commit();
                break;
